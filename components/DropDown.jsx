...
function DropDown({ openSideBar, setOpenSideBar }) {
	return (
		<div
			className={`flex-col overflow-hidden items-center fixed h-[46rem] md:h-screen z-50 inset-y-0 right-0 overflow-x-hidden bg-[#053f3f] transition-width duration-500 ease-in-out ${
		...
		>
			...
			<div className='space-y-6 md:space-y-10 flex h-full flex-col justify-center md:text-lg'>
				...
				>
					...
					<h2 className='text-gray-300 font-semibold tracking-wider md:text-lg'>
						About
					</h2>
				</a>
				<a
				...
				>
					...
					<h2 className='text-gray-300 font-semibold tracking-wider md:text-lg mb-10'>
						Contact
					</h2>
				</a>
