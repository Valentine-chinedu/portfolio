		...
		>
			<div className='flex w-full flex-col items-center '>
				<div className='mb-8 flex w-full items-center justify-center space-x-2 md:mb-12 md:space-x-4 lg:mb-14 lg:space-x-8'>
					...
					<h3 className='font-bold uppercase text-gray-600 dark:text-gray-200 md:text-xl'>
						{title}
					</h3>
					<span className='h-0.5 w-20 bg-fuchsia-600 dark:bg-[#00FFFF] md:w-40 lg:w-60'></span>
				</div>
				<div className='relative mb-4 h-80 w-80 md:h-96 md:w-96'>
					<Image src={image} alt='profile picture' layout='fill' />
				</div>

				<p className='mb-6 w-full px-4 text-sm font-medium md:text-base lg:w-4/5 lg:px-0'>
					{description}
				</p>
				<ul className=' w-full justify-center px-4 lg:flex lg:space-x-8'>
					{tags.map((tag) => (
