			...
			>
				<div className='relative flex flex-col items-center space-y-2 px-6 font-medium text-gray-300 md:space-y-4 md:px-20 md:text-lg lg:w-3/6 lg:space-y-6 lg:px-0 lg:text-lg'>
					...
					<div className='space-y-2'>
						...
						>
							<p>
								My interest in software development started while working as a
								business developer in Lagos, Nigeria, I noticed that most
								problems our clients and their customers faced was around
