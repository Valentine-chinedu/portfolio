			...
			<div className='z-10 flex h-full w-full flex-col justify-center lg:items-start  '>
				<div className='flex w-full flex-col items-center justify-center space-y-6  md:space-y-14 lg:w-9/12 lg:flex-row lg:space-x-12'>
					...
					{/* <motion.div
						...
						animate={{ opacity: 1, x: 0 }}
						transition={{ duration: 1.5, ease: 'easeIn', delay: 0.5 }}
						className='flex h-60 w-60 justify-center rounded-full bg-cyan-900 bg-opacity-60 lg:h-[25rem] lg:w-[25rem]'
					>
						<svg
							className='h-48 w-48 rotate-12 md:h-80 md:w-80 lg:h-[20rem] lg:w-[20rem]'
						...
						>
							...
							/>
							<path
								id='ac220ed6-7c3f-4d1e-8d82-3295770c496a-139'
								data-name='Path 1461'
							...
							<path
								...
								transform='translate(-160.68481 -208.5)'
								fill={theme === 'dark' ? '#00ffff' : '#c108da'}
							/>
							<path
								id='bb46eb08-8e3e-4ac5-913b-26d221d967b9-140'
								data-name='Path 1421'
							...
							/>
							<path
								id='efe93a1e-ccdd-49fd-af5f-e26394aa0937-141'
								data-name='Path 1430'
							...
							/>
							<path
								id='a38c3c09-000b-42b7-8619-0229d8aff5e9-142'
								data-name='Path 1421'
							...
							/>
							<path
								id='bd3879bf-5d05-49be-b690-c4d97e29a2ab-143'
								data-name='Path 1430'
