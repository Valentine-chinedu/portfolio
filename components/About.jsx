				...
				<Fade bottom duration={1000}>
					<div className=''>
						...
						<div className='flex flex-col space-y-6 tracking-wider overflow-hidden text-sm md:text-lg text-gray-300 lg:tracking-normal lg:mr-4'>
							...
							<p>
								I am currently focused on front-end, my motivation is to use my
								web development skills to develop results driven websites which
								offers maximum business solution potentials and sustained
								clients satisfaction.
							</p>
							<p className='pb-9 md:pb-16'>
								Currently, I am available for a suitable web development
