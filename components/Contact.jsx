...
function Contact() {
	...
	return (
		...
		>
			<motion.div
				animate={animation}
				className='flex flex-col items-center justify-between h-full w-4/5'
			>
				...
				<div className='flex relative pb-4 lg:pb-6 items-center justify-center space-x-8 md:space-x-16 lg:w-3/5'>
					<a
