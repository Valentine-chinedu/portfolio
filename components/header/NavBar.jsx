...
const NavBar = ({ openSideBar, setOpenSideBar }) => {
	return (
		<>
			<nav
				className={` fixed inset-y-0 right-0 flex flex-col items-center justify-center space-y-16 overflow-x-hidden bg-slate-900 text-lg font-bold text-gray-50/80 md:space-y-20 md:text-xl lg:relative lg:h-10 lg:w-[35rem] lg:flex-row lg:space-x-4 lg:space-y-0 lg:bg-opacity-0 lg:text-sm ${
